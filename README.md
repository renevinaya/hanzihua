# hanzihua
Learning Chinese needs a constant effort, as you are rarely exposed to it during daily life. So, I am making a picture
frame with an epaper display which shows me a Chinese word per day:
...
creates pages for the 31 words with the lowest score (one for each day of the longest month). The page is switched daily.
